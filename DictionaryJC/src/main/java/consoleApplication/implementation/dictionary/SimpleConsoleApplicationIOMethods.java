...
public class SimpleConsoleApplicationIOMethods implements DictionaryInterface {
    ...
    public File defineDictionaryType(String dictionaryType){
    ...
    public void  findEntryInDictionary(){
        ...
        try(BufferedReader br = new BufferedReader(new FileReader(fileType))){
            ...
            } else beanFactory.getObjectCommunicationWithTheUser().showMessege(MessegesForUser.STRING_NOT_FOUND.getMessege());
        }
        ...
        try{
            if(chekRowExistensBeforeDeleting(searchString,fileType)){
                try ( BufferedWriter bw = new BufferedWriter(new FileWriter(temporaryFile));
                    ...
                    } else beanFactory.getObjectCommunicationWithTheUser().showErrorMessege(MessegesForUser.DELETE_FAILED.getMessege());
                    ...
                    } else beanFactory.getObjectCommunicationWithTheUser().showErrorMessege(MessegesForUser.RENAME_FAILED.getMessege());
                } else beanFactory.getObjectCommunicationWithTheUser().showErrorMessege(MessegesForUser.STRING_NOT_FOUND.getMessege());
